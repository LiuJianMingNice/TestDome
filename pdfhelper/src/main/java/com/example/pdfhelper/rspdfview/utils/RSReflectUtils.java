package com.example.pdfhelper.rspdfview.utils;
 ...
 * @date 2022-07-20
 */
public final class RSReflectUtils {

    private final Class<?> type;

    private final Object object;

    private RSReflectUtils(final Class<?> type) {
        this(type, type);
    }

    private RSReflectUtils(final Class<?> type, Object object) {
        this.type = type;
        this.object = object;
    }
     ...
     * @return the single {@link RSReflectUtils} instance
     * @throws RSReflectUtils.ReflectException if reflect unsuccessfully
     */
    public static RSReflectUtils reflect(final String className)
            throws RSReflectUtils.ReflectException {
     ...
     * @throws RSReflectUtils.ReflectException if reflect unsuccessfully
     */
    public static RSReflectUtils reflect(final String className, final ClassLoader classLoader)
            throws RSReflectUtils.ReflectException {
     ...
     * @throws RSReflectUtils.ReflectException if reflect unsuccessfully
     */
    public static RSReflectUtils reflect(final Class<?> clazz)
            throws RSReflectUtils.ReflectException {
        return new RSReflectUtils(clazz);
    }
     ...
     * @throws RSReflectUtils.ReflectException if reflect unsuccessfully
     */
    public static RSReflectUtils reflect(final Object object)
            throws RSReflectUtils.ReflectException {
        return new RSReflectUtils(object == null ? Object.class : object.getClass(), object);
    }
    ...
    private static Class<?> forName(String className) {
        try {
            ...
            throw new RSReflectUtils.ReflectException(e);
        }
    }
     ...
     * @return the single {@link RSReflectUtils} instance
     */
    public RSReflectUtils newInstance() {
     ...
     * @return the single {@link RSReflectUtils} instance
     */
    public RSReflectUtils newInstance(Object... args) {
    ...
    private Class<?>[] getArgsType(final Object... args) {
        ...
        for (int i = 0; i < args.length; i++) {
            Object value = args[i];
            result[i] = value == null ? RSReflectUtils.NULL.class : value.getClass();
        }
        return result;
    }
    ...
    private RSReflectUtils newInstance(final Constructor<?> constructor, final Object... args) {
        try {
            return new RSReflectUtils(
     ...
     * @return the single {@link RSReflectUtils} instance
     */
    public RSReflectUtils field(final String name) {
        try {
            Field field = getField(name);
            return new RSReflectUtils(field.getType(), field.get(object));
     ...
     * @return the single {@link RSReflectUtils} instance
     */
    public RSReflectUtils field(String name, Object value) {
        try {
            Field field = getField(name);
    ...
    private Object unwrap(Object object) {
        if (object instanceof RSReflectUtils) {
            return ((RSReflectUtils) object).get();
        }
        return object;
    }
     ...
     * @throws RSReflectUtils.ReflectException if reflect unsuccessfully
     */
    public RSReflectUtils method(final String name) throws RSReflectUtils.ReflectException {
     ...
     * @throws RSReflectUtils.ReflectException if reflect unsuccessfully
     */
    public RSReflectUtils method(final String name, final Object... args) throws RSReflectUtils.ReflectException {
        Class<?>[] types = getArgsType(args);
        try {
            ...
            try {
                ...
                throw new RSReflectUtils.ReflectException(e1);
            }
        }
    }

    private RSReflectUtils method(final Method method, final Object obj, final Object... args) {
        try {
            accessible(method);
    ...
    private boolean match(final Class<?>[] declaredTypes, final Class<?>[] actualTypes) {
        if (declaredTypes.length == actualTypes.length) {
            for (int i = 0; i < actualTypes.length; i++) {
                if (actualTypes[i] == RSReflectUtils.NULL.class
    ...
    public <P> P proxy(final Class<P> proxyType) {
        ...
        final InvocationHandler handler = new InvocationHandler() {
            ...
            public Object invoke(Object proxy, Method method, Object[] args) {
                ...
                } catch (RSReflectUtils.ReflectException e) {
                    if (isMap) {
    ...
    public boolean equals(Object obj) {
        return obj instanceof RSReflectUtils && object.equals(((RSReflectUtils) obj).get());
    }
