...
public class MyPagerSnapHelper extends SnapHelper {
    ...
    protected RecyclerView.SmoothScroller createScroller(RecyclerView.LayoutManager layoutManager) {
        final RecyclerView mRecyclerView = RSReflectUtils.reflect(this).field("mRecyclerView").get();
...
//    }
    ...
    private OrientationHelper getVerticalHelper(@NonNull RecyclerView.LayoutManager layoutManager) {
        ...
        if (mVerticalHelper != null) {
            mLayoutManager = RSReflectUtils.reflect(mVerticalHelper).field("mLayoutManager").get();
        }
    ...
    private OrientationHelper getHorizontalHelper(@NonNull RecyclerView.LayoutManager layoutManager) {
        ...
        if (mHorizontalHelper != null) {
            mLayoutManager = RSReflectUtils.reflect(mHorizontalHelper).field("mLayoutManager").get();
        }
