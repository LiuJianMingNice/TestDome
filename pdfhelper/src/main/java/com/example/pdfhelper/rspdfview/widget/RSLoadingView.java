 ...
 * @date 2022-07-20
 */
public class RSLoadingView extends View {
    ...
    public RSLoadingView(Context context) {
        super(context);
        init();
    }

    public RSLoadingView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public RSLoadingView(Context context, AttributeSet attrs, int defStyleAttr) {
