...
public class TestIO1 {
    ...
    public static void printStream() throws FileNotFoundException, IOException {
        try(FileOutputStream fos = new FileOutputStream("/home/liujianming/桌面/TestIO/tmp2.txt");
            PrintStream ps = new PrintStream(fos)) {
            ps.println("普通字符串\n");
            //输出对象
            ps.println(new TestIO1());
        } catch (IOException e) {
            e.printStackTrace();
        }
    ...
    public static void pushback() throws FileNotFoundException,IOException {
        try(PushbackReader pr = new PushbackReader(new FileReader("/home/liujianming/Android项目/TestDemo1/app/src/main/java/com/example/liujianming/testdemo1/test/architect/generic/TestIO1.java"),64)) {
            char[] buf = new char[32];
            String lastContent = "";
            int hasRead = 0;
