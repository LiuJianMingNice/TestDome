...
import com.example.liujianming.testdemo1.android.interfaces.ISegmentedControl;
import com.example.liujianming.testdemo1.android.states.SelectedItemState;
...
public class SegmentedControlView extends View implements ISegmentedControl {
    ...
    public SegmentedControlView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    public SegmentedControlView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        cornersRadius = typedArray.getDimensionPixelSize(R.styleable.SegmentedControlView_segCornersRadius, DEFAULT_RADIUS);
        backgroundColor = typedArray.getColor(R.styleable.SegmentedControlView_segBackgroundColor, DEFAULT_OUTER_COLOR);
        selectedItemBackgroundColor = typedArray.getColor(R.styleable.SegmentedControlView_segSelectedItemBackgroundColor, DEFAULT_ITEM_COLOR);
        textColor = typedArray.getColor(R.styleable.SegmentedControlView_segTextColor, DEFAULT_TEXT_COLOR);
        selectedItemTextColor = typedArray.getColor(R.styleable.SegmentedControlView_segSelectedItemTextColor, DEFAULT_SELECTED_TEXT_COLOR);
        itemHorizontalMargin = typedArray.getDimensionPixelSize(R.styleable.SegmentedControlView_segItemHorizontalMargin, 0);
        itemVerticalMargin = typedArray.getDimensionPixelSize(R.styleable.SegmentedControlView_segItemVerticalMargin, 0);
        selectedItem = typedArray.getInteger(R.styleable.SegmentedControlView_segSelectedItem, 0);
        textSize = typedArray.getDimensionPixelSize(R.styleable.SegmentedControlView_segTextSize, (int) getResources().getDimension(R.dimen.seg_textSize));
        cornersMode = typedArray.getInt(R.styleable.SegmentedControlView_segCornersMode, Round);
        scrollSelectEnabled = typedArray.getBoolean(R.styleable.SegmentedControlView_segScrollSelectEnabled, true);
        typedArray.recycle();
    ...
    //画所有未选中Item的文字
    private void drawUnselectItemsText(Canvas canvas) {
        mTextPaint.setColor(textColor);
